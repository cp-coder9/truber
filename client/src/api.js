/** Thin API wrapper. All requests use relative /api paths so the Vite dev
 *  server can proxy them to the backend (never localhost from the browser). */

const TOKEN_KEY = 'bridgetech_token';
const USER_KEY = 'bridgetech_user';
