...
/**
 * InvoiceModal — fetches a printable tax invoice / receipt for a booking and
 * renders a document-style view. The "print" button triggers the browser's
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 720 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <button className="btn btn-outline btn-sm" onClick={() => setInv(null)} style={{ display: 'none' }}>x</button>
            ...
            <div id="invoice-print" className="invoice-doc">
              ...
              <div className="invoice-head">
                <div>
                  ...
                  <div className="invoice-company">
                    {inv.company.country} · Reg {inv.company.regNo} · VAT {inv.company.vatNo}
                  </div>
                </div>
              ...
              <table className="invoice-table">
                ...
                <tbody>
                  {rows.map((it, i) => (
                    <tr key={i}>
                      <td>
                        <div className="bold">{it.label}</div>
              ...
              <div className="invoice-foot">
                {inv.kind === 'invoice'
                  ? 'Payment due within 14 days. Please quote the invoice number with your EFT.'
                  : 'Thank you for shipping with BridgeTech Logistics.'}
              </div>
            </div>
